"""
Django settings for cardiocheck project.
...
SECRET_KEY = 'django-insecure-3+2&en$_!^0r!*e9moh4n(c%_i#)4yaz%ze!$i6qx37l2g4@yj'
...
WSGI_APPLICATION = 'cardiocheck.wsgi.application'
